      ...
      <section className="contact-main" >
        ...
        <ul className="example-2">
          <li className="icon-content">
            <a
              href="https://www.linkedin.com/in/israel-litvak/"
              aria-label="LinkedIn"
          ...
          <li className="icon-content">
            <a href="https://github.com/lisrael1989" aria-label="GitHub" target='blank' data-social="github">
              <div className="filled"></div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
          ...
          <li className="icon-content">
            <a href="mailto:lisrael1989@gmail.com" aria-label="Gmail" target='blank' data-social="gmail">
              <div className="filled"></div>
          ...
          <li className="icon-content">
            <a href="https://wa.me/972528021921" aria-label="WhatsApp" target='blank' data-social="whatsapp">
              <div className="filled"></div>
              <svg
                width="16"
                height="16"
